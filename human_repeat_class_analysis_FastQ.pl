...
sub align_fragments_to_the_human_repeatome {
  ...
  my @fhs = (
      { name => 'LINE',
	repeat_index => '/bi/scratch/Genomes/Human/GRCh37/Repeatome/bedfiles/byClass/LINE/LINE',
      },
      { name => 'SINE',
	repeat_index => '/bi/scratch/Genomes/Human/GRCh37/Repeatome/bedfiles/byClass/SINE/SINE',
      },
      { name => 'LTR',
	repeat_index => '/bi/scratch/Genomes/Human/GRCh37/Repeatome/bedfiles/byClass/LTR/LTR',
      },
      { name => 'DNA',
	repeat_index => '/bi/scratch/Genomes/Human/GRCh37/Repeatome/bedfiles/byClass/DNA/DNA',
      },
      { name => 'Satellite',
	repeat_index => '/bi/scratch/Genomes/Human/GRCh37/Repeatome/bedfiles/byClass/Satellite/Satellite',
      },
      { name => 'Simple_repeat',
	repeat_index => '/bi/scratch/Genomes/Human/GRCh37/Repeatome/bedfiles/byClass/Simple_repeat/Simple_repeat',
      },
      { name => 'Low_complexity',
	repeat_index => '/bi/scratch/Genomes/Human/GRCh37/Repeatome/bedfiles/byClass/Low_complexity/Low_complexity',
      },
      { name => 'tRNA',
	repeat_index => '/bi/scratch/Genomes/Human/GRCh37/Repeatome/bedfiles/byClass/tRNA/tRNA',
      },
      { name => 'rRNA',
	repeat_index => '/bi/scratch/Genomes/Human/GRCh37/Repeatome/bedfiles/byClass/rRNA/rRNA',
      },
      { name => 'RC', # rolling circle helitron
	repeat_index => '/bi/scratch/Genomes/Human/GRCh37/Repeatome/bedfiles/byClass/RC/RC',
      },
      { name => 'RNA',
	repeat_index => '/bi/scratch/Genomes/Human/GRCh37/Repeatome/bedfiles/byClass/RNA/RNA',
      },
      { name => 'scRNA',
	repeat_index => '/bi/scratch/Genomes/Human/GRCh37/Repeatome/bedfiles/byClass/scRNA/scRNA',
      },
      { name => 'snRNA',
	repeat_index => '/bi/scratch/Genomes/Human/GRCh37/Repeatome/bedfiles/byClass/snRNA/snRNA',
      },
      { name => 'srpRNA',
	repeat_index => '/bi/scratch/Genomes/Human/GRCh37/Repeatome/bedfiles/byClass/srpRNA/srpRNA',
      },
      { name => 'telomere',
	repeat_index => '/bi/scratch/Genomes/Human/GRCh37/Repeatome/bedfiles/byClass/telomere/telomere',
      },
    );
