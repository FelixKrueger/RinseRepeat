...
sub align_fragments_to_the_mouse_repeatome {
    ...
    my @fhs = (
	{ name => 'LINE_L1',
	  repeat_index => '/bi/scratch/Genomes/Mouse/GRCm38/Repeatome/repeat_families_N_separated/X_chromosome_only/LINE_L1/LINE_L1.N_sep',
	},
	{ name => 'LINE_L2',
	  repeat_index => '/bi/scratch/Genomes/Mouse/GRCm38/Repeatome/repeat_families_N_separated/X_chromosome_only/LINE_L2/LINE_L2.N_sep',
	},
	{ name => 'LTR_ERV1',
	  repeat_index => '/bi/scratch/Genomes/Mouse/GRCm38/Repeatome/repeat_families_N_separated/X_chromosome_only/LTR_ERV1/LTR_ERV1.N_sep',
	},
	{ name => 'LTR_ERVK',
	  repeat_index => '/bi/scratch/Genomes/Mouse/GRCm38/Repeatome/repeat_families_N_separated/X_chromosome_only/LTR_ERVK/LTR_ERVK.N_sep',
	},
	{ name => 'LTR_ERVL',
	  repeat_index => '/bi/scratch/Genomes/Mouse/GRCm38/Repeatome/repeat_families_N_separated/X_chromosome_only/LTR_ERVL/LTR_ERVL.N_sep',
	},
	{ name => 'LTR_MaLR',
	  repeat_index => '/bi/scratch/Genomes/Mouse/GRCm38/Repeatome/repeat_families_N_separated/X_chromosome_only/LTR_MaLR/LTR_MaLR.N_sep',
	},
	{ name => 'major_satellite',
	  repeat_index => '/bi/scratch/Genomes/Mouse/GRCm38/Repeatome/repeat_families_N_separated/X_chromosome_only/major_satellite/major_satellite.N_sep',
	},
	{ name => 'minor_satellite',
	  repeat_index => '/bi/scratch/Genomes/Mouse/GRCm38/Repeatome/repeat_families_N_separated/X_chromosome_only/minor_satellite/minor_satellite.N_sep',
	},
	{ name => 'rRNA',
	  repeat_index => '/bi/scratch/Genomes/Mouse/GRCm38/Repeatome/repeat_families_N_separated/X_chromosome_only/rRNA/rRNA.N_sep',
	},
	{ name => 'SINE_Alu_B1',                                                                                                                     
	  repeat_index => '/bi/scratch/Genomes/Mouse/GRCm38/Repeatome/repeat_families_N_separated/X_chromosome_only/SINE_Alu_B1/SINE_Alu_B1.N_sep',                                                           	},    
	{ name => 'SINE_B2',
	  repeat_index => '/bi/scratch/Genomes/Mouse/GRCm38/Repeatome/repeat_families_N_separated/X_chromosome_only/SINE_B2/SINE_B2.N_sep',
	},
	{ name => 'SINE_B4',
	  repeat_index => '/bi/scratch/Genomes/Mouse/GRCm38/Repeatome/repeat_families_N_separated/X_chromosome_only/SINE_B4/SINE_B4.N_sep',
	},
	####  Note that the telomere sequence is not specific or the X chromosome!
	{ name => 'telomere',
